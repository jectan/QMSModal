...
class CreateOfficeAssignedTicketsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('office_assigned_tickets', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('ticket_id')
                  ...
                  ->on('tickets')
                  ->onDelete('cascade');
            $table->enum('status', array('pending', 'received', 'working','resolved','unresolved'))->default('pending');
    ...
    {
        Schema::dropIfExists('office_assigned_tickets');
    }
}
