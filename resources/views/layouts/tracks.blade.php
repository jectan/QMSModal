...
<div class="modal fade" id="role-modal" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form action="javascript:void(0)" id="track-form" name="role_form" class="form-horizontal"  enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="ticket_number" placeholder="Enter Role" maxlength="50" required="">
                        </div>
...
<script type="text/javascript">
    ...
    $('#track-form').submit(function(e) {
        ...
        $.ajax({
            type:'GET',
            url: "{{ url('/tracks/search')}}/"+$('#ticket_number').val(),
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
