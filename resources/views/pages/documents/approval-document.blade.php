...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <table class="table table-striped w-100" id="approval-dt" style="font-size: 14px">
            <thead>
                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#approval-dt').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('documents.data-request', ['status' => 'For Approval']) }}", // Fetch data from this route
            columns: [
