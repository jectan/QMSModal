...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <table class="table table-striped w-100" id="pm-dt" style="font-size: 14px">
            <thead>
                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#pm-dt').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('/masterlist/data-request/5') }}", // Fetch data from this route
            columns: [
            ...
            language: {
                emptyTable: 'There are no registered Procedure Manuals'
            }
        });
    });
</script>
