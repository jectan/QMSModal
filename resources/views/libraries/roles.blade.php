        ...
        <div class="btn-group mr-2">
            <div class="container-login100-form-btn">
                <div class="wrap-login100-form-btn">
                    ...
                    <button class="login100-form-btn" data-toggle="modal" data-target="#role-modal"><i class="fa fa-plus pr-2"></i>Roles</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="role-modal-title"> Add Role Classification</h4>
            </div>
            <form action="javascript:void(0)" id="role-form" name="role_form" class="form-horizontal" method="POST" enctype="multipart/form-data">
